...
```
PS C:> Remove-AzAutomationCertificate -AutomationAccountName Contoso17 -Confirm  -Name Cert01 -ResourceGroupName ResourceGroup01
```

The Remove-AzAutomationCertificate cmdlet removes a certificate from Azure Automation. (autogenerated)

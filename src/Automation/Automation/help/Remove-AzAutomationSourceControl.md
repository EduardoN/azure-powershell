...
PS C:> Remove-AzAutomationSourceControl -AutomationAccountName AutomationAccount01 -Name Configuration01 -ResourceGroupName MyResourceGroup
```

The Remove-AzAutomationSourceControl cmdlet removes a source control from Azure Automation. (autogenerated)

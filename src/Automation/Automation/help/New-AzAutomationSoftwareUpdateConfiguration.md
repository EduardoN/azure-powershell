...
Creates a software update configuration that runs on a schedule to update a list of computers. Computers include both azure virtual machines or non-az computers. (autogenerated)

...
PS C:> New-AzAutomationSoftwareUpdateConfiguration -AutomationAccountName AutomationAccount01 -AzureVMResourceId <String> -Duration {Duration} -IncludedKbNumber {IncludedKbNumber} -ResourceGroupName MyResourceGroup -Schedule <Schedule> -Windows 
```

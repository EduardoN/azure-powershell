...
PS C:> Get-AzAutomationSourceControlSyncJobOutput -AutomationAccountName AutomationAccount01 -JobId 00000000-0000-0000-0000-000000000000 -ResourceGroupName rg1 -SourceControlName VSTSNative
```

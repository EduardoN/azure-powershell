...
PS C:> Set-AzAutomationCertificate -AutomationAccountName Contos17 -Name ContosoCertificate -Path ./cert.pfx -ResourceGroupName ResourceGroup01
```

The Set-AzAutomationCertificate cmdlet modifies the configuration of a certificate in Azure Automation. (autogenerated)

...
The New-AzRecoveryServicesAsrvCenter cmdlet adds a vCenter server to discover protectable items from. This cmdlet registers the vCenter server for discovery with the Configuration server. (autogenerated)

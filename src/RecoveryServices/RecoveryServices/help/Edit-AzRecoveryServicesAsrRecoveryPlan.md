...
PS C:> Edit-AzRecoveryServicesAsrRecoveryPlan -AppendGroup  -InputObject $RP
```

Appends a group to existing Azure Site Recovery plan and returns the in-memory updated recovery plan.  (autogenerated)

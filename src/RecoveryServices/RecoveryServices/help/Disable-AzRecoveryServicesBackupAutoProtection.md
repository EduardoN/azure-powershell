...
```
PS C:> Disable-AzRecoveryServicesBackupAutoProtection -BackupManagementType AzureVM -WorkloadType AzureVM
```

The first cmdlet disables the Backup protection policy. (autogenerated)

...
PS C:> Set-AzRecoveryServicesAsrReplicationProtectedItem -InputObject $RPI -PrimaryNic 00:50:56:8F:3F:7B -RecoveryNetworkId $AzureNetworkID -RecoveryNicStaticIPAddress {RecoveryNicStaticIPAddress} -RecoveryNicSubnetName $recoverySubnet
```

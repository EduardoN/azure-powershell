...
```
PS C:> Set-AzRecoveryServicesAsrReplicationProtectedItem -InputObject $RPI -RecoveryNetworkId $AzureNetworkID -RecoveryNicStaticIPAddress 10.0.0.1 -RecoveryNicSubnetName $recoverySubnet -UpdateNic $NicId
```

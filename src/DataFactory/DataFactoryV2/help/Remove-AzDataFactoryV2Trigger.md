...
The Remove-AzDataFactoryV2Trigger cmdlet removes a trigger from a data factory. If the Force parameter is specified, the cmdlet doesn't prompt before removing the trigger. (autogenerated)

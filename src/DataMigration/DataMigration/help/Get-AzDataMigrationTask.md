...
```
PS C:> Get-AzDataMigrationTask -Expand  -Name testProject -ProjectName myTestProject -ResourceGroupName MyResourceGroup -ResultType MigrationLevelOutput -ServiceName testService
```

...
PS C:> Remove-AzDataMigrationTask -Name TestTask -ProjectName myTestProject -ResourceGroupName MyResourceGroup -ServiceName MyTestService
```

The preceding example removes an Azure Database Migration Service task named TestTask from Azure based on task name parameter. (autogenerated)

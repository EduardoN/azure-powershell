...
PS C:> Get-AzDataShareTrigger -AccountName WikiAds -ResourceGroupName ADS -ShareSubscriptionName AdsShareSubscription
```

The Get-AzDataShareTrigger cmdlet gets information about trigger for share subscription under data share account. (autogenerated)

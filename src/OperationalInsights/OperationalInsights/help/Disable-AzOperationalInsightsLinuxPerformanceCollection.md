...
## DESCRIPTION
The **Disable-AzOperationalInsightsLinuxPerformanceCollection** cmdlet stops collection of performance counters from connected Linux computers in a workspace.

## EXAMPLES

```
PS C:> Disable-AzOperationalInsightsLinuxPerformanceCollection -ResourceGroupName MyResourceGroup -WorkspaceName ContosoWorkspace
```

The Disable-AzOperationalInsightsLinuxPerformanceCollection cmdlet stops collection of performance counters from connected Linux computers in a workspace. (autogenerated)

...
The Disable-AzOperationalInsightsLinuxCustomLogCollection cmdlet stops collection of custom logs from connected Linux computers in a workspace. (autogenerated)

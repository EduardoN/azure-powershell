...
```
PS C:> Remove-AzADUser -DisplayName MyNewDisplayName -Force 
```

Deletes an active directory user (work/school account also popularly known as org-id). (autogenerated)

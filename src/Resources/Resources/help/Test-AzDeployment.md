...
```
PS C:> Test-AzDeployment -Location West US -TemplateFile D:\Azure\Templates\EngineeringSite.json -TemplateParameterObject <Hashtable>
```

The Test-AzDeployment cmdlet determines whether a deployment template and its parameter values are valid. (autogenerated)

...
PS C:> Set-AzKeyVaultCertificatePolicy -EmailAtNumberOfDaysBeforeExpiry {EmailAtNumberOfDaysBeforeExpiry} -Name TestCert01 -ValidityInMonths 6 -VaultName ContosoKV01
```

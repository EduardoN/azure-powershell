...
PS C:> Publish-AzWebApp -ArchivePath C:projectapp.zip -Force  -Name ContosoApp -ResourceGroupName ContosoRG
```

The Publish-AzWebApp cmdlet uploads content to an existing Azure Web App (autogenerated)

...
```
PS C:> Get-AzWebAppSlotPublishingProfile -Name ContosoWebApp -ResourceGroupName Default-Web-WestUS -Slot slot001
```

The Get-AzWebAppSlotPublishingProfile cmdlet gets the Web App publishing profile for the specified slot. (autogenerated)

...
```
PS C:> Restore-AzWebAppBackup -BlobName myBlob -Name ContosoWebApp -Overwrite  -ResourceGroupName Default-Web-WestUS -Slot Slot001 -StorageAccountUrl https://storageaccount.file.core.windows.net
```

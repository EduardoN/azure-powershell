...
PS C:> Set-AzApiManagementApiRevision -ApiId echo-api -ApiRevision 2 -Context $ApiMgmtContext -SubscriptionKeyHeaderName {SubscriptionKeyHeaderName} -SubscriptionKeyQueryParamName {SubscriptionKeyQueryParamName} -SubscriptionRequired 
```

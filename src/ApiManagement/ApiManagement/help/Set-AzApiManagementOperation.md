...
```
PS C:> Set-AzApiManagementOperation -ApiId 0001 -Context $ApiMgmtContext -Method GET -Name ContosoApi -OperationId Operation003 -TemplateParameters {TemplateParameters} -UrlTemplate /newresource
```

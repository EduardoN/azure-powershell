...
```
PS C:> Set-AzApiManagementSubscription -Context $apimContext -PrimaryKey 00000000-0000-0000-0000-000000000000 -SecondaryKey 00000000-0000-0000-0000-000000000000 -State Suspended -SubscriptionId 0123456789
```

This command sets the primary and secondary keys for a subscription and activates it. (autogenerated)

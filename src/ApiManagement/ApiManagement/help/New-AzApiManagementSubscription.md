...
PS C:> New-AzApiManagementSubscription -Context $apimContext -Name GlobalApiScope -ProductId 999 -UserId 777
```

The New-AzApiManagementSubscription cmdlet creates a subscription. (autogenerated)

...
```
PS C:> Update-AzApiManagementCache -AzureRedisResourceId {AzureRedisResourceId} -CacheId centralus -ConnectionString teamdemo.redis.cache.windows.net:6380,password=xxxxxx+xxxxx=,ssl=True,abortConnect=False -Context $context -Description Team new cache
```

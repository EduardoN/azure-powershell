...
```
PS C:> New-AzApiManagementUser -Context $apimContext -Email Patti.Fuller@contoso.com -FirstName Patti -LastName Fuller -Password $securePassword -UserId 0123456789
```

The New-AzApiManagementUser cmdlet registers a new user. (autogenerated)

...
```
PS C:> New-AzApiManagementIdentityProvider -AllowedTenants samirtestbc.onmicrosoft.com -Authority {Authority} -ClientId 00000000-0000-0000-0000-000000000000 -ClientSecret foobar -Context $apimContext -PasswordResetPolicyName {PasswordResetPolicyName} -ProfileEditingPolicyName {ProfileEditingPolicyName} -SigninPolicyName {SigninPolicyName} -SignupPolicyName B2C_1_signup-policy -Type Facebook
```

...
```
PS C:> Remove-AzApiManagementApiVersionSet -ApiVersionSetId query-param-set -Context $apimContext
```

This command removes the API Version Set with the specified ApiVersionSetId. (autogenerated)

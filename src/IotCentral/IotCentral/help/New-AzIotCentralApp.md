...
```
PS C:> New-AzIotCentralApp -DisplayName My Custom Display Name -Location westus -Name MyAppResourceName -ResourceGroupName MyResourceGroupName -Sku S1 -Subdomain MyAppSubdomain -Template iotc-default
```

Creates a new IoT Central Application with the provided properties and metadata. For an introduction to IoT Central, see https://docs.microsoft.com/en-us/azure/iot-central/. (autogenerated)

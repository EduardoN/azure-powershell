...
```
PS C:> Set-AzEventHubGeoDRConfigurationBreakPair -InputObject $inputobject
```

The Set-AzEventHubGeoDRConfigurationBreakPair cmdlet disables the Disaster Recovery and stops replicating changes from primary to secondary namespaces (autogenerated)

...
PS C:> Remove-AzEventHubNetworkRuleSet -Name Eventhub-Namespace1-1375 -PassThru  -ResourceGroupName v-ajnavtest
```

Removes the NetworkRuleSet for the Given Namespace. (autogenerated)

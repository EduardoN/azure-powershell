...
PS C:> Add-AzHDInsightStorage -StorageAccountKey {StorageAccountKey} -StorageAccountName {StorageAccountName}
```

This command adds an blob storage account entry to the HDInsight configuration named your-hadoop-001. (autogenerated)

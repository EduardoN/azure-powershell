...
```
PS C:> Get-AzHDInsightJob -ClusterName $clusterName -HttpCredential $clusterCreds
```

This command gets all recent jobs for the cluster named your-hadoop-001. (autogenerated)

...
```
PS C:> Get-AzReservationCatalog -ReservedResourceType SuseLinux
```

Get the regions and skus that are available for Reserved Instance purchase for the specified Azure subscription. (autogenerated)

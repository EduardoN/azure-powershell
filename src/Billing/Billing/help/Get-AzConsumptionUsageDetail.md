...
PS C:> Get-AzConsumptionUsageDetail -EndDate 2017-10-05 -InstanceName 1c2052westus -ResourceGroup {ResourceGroup} -StartDate 2017-10-02
```

The Get-AzConsumptionUsageDetail cmdlet gets usage details of the subscription. (autogenerated)

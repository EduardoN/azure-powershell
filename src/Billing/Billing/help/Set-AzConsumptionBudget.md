...
PS C:> Set-AzConsumptionBudget -Amount 75 -Category Cost -ContactEmail johndoe@contoso.com,janesmith@contoso.com -EndDate 2018-01-20 -Name PSBudget -NotificationEnabled  -NotificationKey notificationKey-ps1234 -NotificationThreshold 90 -ResourceGroupName RGBudgets -StartDate 2018-01-03 -TimeGrain Monthly
```

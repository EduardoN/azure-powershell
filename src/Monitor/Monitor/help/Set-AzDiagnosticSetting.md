...
```
PS C:> Set-AzDiagnosticSetting -Category Category1,Category2 -DefaultProfile {DefaultProfile} -Enabled $False -EventHubAuthorizationRuleId {EventHubAuthorizationRuleId} -EventHubName {EventHubName} -Name MySetting -ResourceId Resource01
```

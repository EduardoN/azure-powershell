...
```
PS C:> Get-AzMetric -AggregationType None -DetailedOutput  -MetricName PageViews -ResourceId /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default-Web-EastUS/providers/microsoft.web/sites/website3 -StartTime 2018-02-01T12:00:00Z -TimeGrain 00:01:00
```

The Get-AzMetric cmdlet gets the metric values for a specified resource. (autogenerated)

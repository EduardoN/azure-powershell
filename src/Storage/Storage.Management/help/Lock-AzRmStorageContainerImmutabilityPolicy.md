...
```
PS C:> Lock-AzRmStorageContainerImmutabilityPolicy -ContainerName myContainer -Etag $policy.Etag -Force  -ResourceGroupName myResourceGroup -StorageAccountName myStorageAccount
```

The Lock-AzRmStorageContainerImmutabilityPolicy cmdlet locks ImmutabilityPolicy of a Storage blob containers. (autogenerated)

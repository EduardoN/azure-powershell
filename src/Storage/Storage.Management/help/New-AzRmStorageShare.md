...
```
PS C:> New-AzRmStorageShare -Name myshare -QuotaGiB 100 -ResourceGroupName myResourceGroup -StorageAccountName myStorageAccount
```

The New-AzRmStorageShare cmdlet creates a Storage file share. (autogenerated)

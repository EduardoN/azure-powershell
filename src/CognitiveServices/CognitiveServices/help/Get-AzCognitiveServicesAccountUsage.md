...
```
PS C:> Get-AzCognitiveServicesAccountUsage -InputObject $acc
```

The Get-AzCognitiveServicesAccountUsage cmdlet gets current usages for a Cognitive Services account. (autogenerated)

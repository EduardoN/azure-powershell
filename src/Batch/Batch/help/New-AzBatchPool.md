...
PS C:> New-AzBatchPool -BatchContext $Context -Id AutoScalePool -TargetDedicatedComputeNodes 3 -TaskSchedulingPolicy {TaskSchedulingPolicy} -VirtualMachineConfiguration $configuration -VirtualMachineSize STANDARD_D1_V2
```

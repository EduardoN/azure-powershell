...
```
PS C:> New-AzBatchCertificate -BatchContext $Context -FilePath E:\Certificates\MyCert.cer -Password Password1234
```

The New-AzBatchCertificate cmdlet adds a certificate to the specified Azure Batch account. (autogenerated)

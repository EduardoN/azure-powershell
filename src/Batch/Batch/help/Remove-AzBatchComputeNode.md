...
```
PS C:> Remove-AzBatchComputeNode -BatchContext $Context -DeallocationOption Requeue -Force  -WhatIf 
```

The Remove-AzBatchComputeNode cmdlet removes Azure Batch compute nodes from a pool. (autogenerated)

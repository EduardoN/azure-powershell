...
PS C:> Get-AzDeploymentManagerArtifactSource -ResourceGroupName ContosoResourceGroup
```

The Get-AzDeploymentManagerArtifactSource cmdlet gets an artifact source, and returns an object that represents that artifact source (autogenerated)

...
```
PS C:> New-AzWcfRelay -Name TestHybirdConnection1 -Namespace TestNameSpace-HybirdConnection -RequiresClientAuthorization $True -RequiresTransportSecurity $True -ResourceGroupName Default-ServiceBus-WestUS -WcfRelayType NetTcp
```

The New-AzWcfRelay cmdlet creates a WcfRelay in the specified Relay namespace. (autogenerated)

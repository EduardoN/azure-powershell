...
```
PS C:> New-AzRelayHybridConnection -Name TestHybirdConnection2 -Namespace TestNameSpace-HybirdConnection -ResourceGroupName Default-Storage-WestUS -UserMetadata User Meta data
```

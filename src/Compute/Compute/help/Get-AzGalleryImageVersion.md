...
```
PS C:> Get-AzGalleryImageVersion -GalleryImageDefinitionName {GalleryImageDefinitionName} -GalleryName gallery1 -Name 1* -ResourceGroupName rg1
```

Get or list gallery image versions. (autogenerated)

...
PS C:> Update-AzGalleryImageVersion -AsJob  -GalleryImageDefinitionName image1 -GalleryName $galleryName -Name $versionName -ResourceGroupName $rgname -Tag Sql -TargetRegion $targetRegions
```

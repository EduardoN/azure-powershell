...
PS C:> Set-AzVMBginfoExtension -ResourceGroupName MyResourceGroup -VMName VM01
```

The Set-AzVMBGInfoExtension cmdlet adds the BGInfo extension to a virtual machine. (autogenerated)

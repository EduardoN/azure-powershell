...
```
PS C:> Add-AzVmssVMDataDisk -CreateOption Attach -Lun 0 -ManagedDiskId $disk.Id -VirtualMachineScaleSetVM $VmssVM
```

The Add-AzVmssVMDataDisk cmdlet adds a data disk to a Vmss VM. (autogenerated)

...
```
PS C:> Get-AzVMAEMExtension -Name AgentPool01 -ResourceGroupName ResourceGroup11 -VMName contoso-server
```

The Get-AzVMAEMExtension cmdlet gets information about the Azure Enhanced Monitoring (AEM) extension. (autogenerated)

...
PS C:> New-AzGalleryImageVersion -AsJob  -GalleryImageDefinitionName image1 -GalleryName $galleryName -Location $location -Name $versionName -PublishingProfileExcludeFromLatest  -ResourceGroupName $rgname -SourceImageId $sourceImageId -Tag Sql -TargetRegion $targetRegions
```

...
```
PS C:> New-AzVmssIpTagConfig -IpTagType FirstPartyUsage -Tag Sql
```

This command creates an IP Tag local object with 'FirstPartyUsage' type and 'Sql' tag, and then creates an IP configuration with this IP tag. (autogenerated)

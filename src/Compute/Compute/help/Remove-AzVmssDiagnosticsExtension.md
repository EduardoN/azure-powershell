...
```
PS C:> Remove-AzVmssDiagnosticsExtension -VirtualMachineScaleSet $VMSS
```

The Remove-AzVmssDiagnosticsExtension cmdlet removes a diagnostics extension from the Virtual Machine Scale Set (VMSS). (autogenerated)

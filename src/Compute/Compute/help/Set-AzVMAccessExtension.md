...
PS C:> Set-AzVMAccessExtension -Credential $vmCred -Location Central US -Name ContosoTest -ResourceGroupName ResourceGroup11 -TypeHandlerVersion 2.0 -VMName VirtualMachine07
```

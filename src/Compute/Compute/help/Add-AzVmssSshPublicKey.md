...
```
PS C:> Add-AzVmssSshPublicKey -KeyData MIIDszCCApugAwIBAgIJALBV9YJCF/tAMA0GCSq12Ib3DQEB21QUAMEUxCzAJBgNV -Path /home/admin/.ssh/authorized_keys
```

The Add-AzVmssSshPublicKey cmdlet adds the public keys that you can use to connect to the Virtual Machine Scale Set (VMSS) virtual machines over Secure Shell (SSH). (autogenerated)

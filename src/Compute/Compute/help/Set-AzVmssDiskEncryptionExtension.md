...
```
PS C:> Set-AzVmssDiskEncryptionExtension -DiskEncryptionKeyVaultId $KeyVaultResourceId -DiskEncryptionKeyVaultUrl $DiskEncryptionKeyVaultUrl -ResourceGroupName $RGName -VMScaleSetName $VmssName -VolumeType $volumeType
```

This command enables encryption on the data disks of all Linux VMs in a VM scale set. (autogenerated)

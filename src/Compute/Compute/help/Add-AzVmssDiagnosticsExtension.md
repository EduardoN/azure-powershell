...
```
PS C:> Add-AzVmssDiagnosticsExtension -SettingFilePath $publicConfigPath
```

The Add-AzVmssDiagnosticsExtension cmdlet adds a diagnostics extension to the Virtual Machine Scale Set (VMSS) instance. (autogenerated)

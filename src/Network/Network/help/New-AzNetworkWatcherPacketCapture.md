...
PS C:> New-AzNetworkWatcherPacketCapture -NetworkWatcher $networkWatcher -PacketCaptureName PacketCaptureTest -StorageAccountId $storageAccount.id -TargetVirtualMachineId $vm.Id -TimeLimitInSeconds 60
```

The New-AzNetworkWatcherPacketCapture cmdlet creates a new packet capture resource and starts a packet capture session on a VM (autogenerated)

...
```
PS C:> Stop-AzNetworkWatcherConnectionMonitor -Location westus -Name cm
```

The Stop-AzNetworkWatcherConnectionMonitor cmdlet stops the specified connection monitor. (autogenerated)

...
```
PS C:> New-AzFirewallNetworkRule -DestinationAddress  -DestinationPort * -Name all-tcp-traffic -Protocol Any -SourceAddress 
```

The New-AzFirewallNetworkRule cmdlet creates an network rule for Azure Firewall. (autogenerated)

...
PS C:> New-AzVirtualWan -AllowBranchToBranchTraffic $true -AllowVnetToVnetTraffic $false -Location Central US -Name MyVirtualWan -ResourceGroupName TestResourceGroup
```

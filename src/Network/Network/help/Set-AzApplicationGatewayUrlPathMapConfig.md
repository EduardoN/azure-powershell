...
```
PS C:> Set-AzApplicationGatewayUrlPathMapConfig -ApplicationGateway $appgw -DefaultBackendAddressPoolId <String> -DefaultBackendHttpSettingsId <String> -Name map01 -PathRules $PathRuleConfig
```

...
```
PS C:> Set-AzNetworkInterfaceIpConfig -LoadBalancerBackendAddressPool {LoadBalancerBackendAddressPool} -Name $nic.IpConfigurations[0].Name -NetworkInterface $sourceNic
```

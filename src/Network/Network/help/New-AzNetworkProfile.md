...
```
PS C:> New-AzNetworkProfile -ContainerNicConfig $containerNicConfig -Location West US -Name np1 -ResourceGroupName rg1
```

The New-AzNetworkProfile cmdlet creates a new network profile top level resource. (autogenerated)

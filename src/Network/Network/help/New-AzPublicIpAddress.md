...
```
PS C:> New-AzPublicIpAddress -AllocationMethod Dynamic -Location $LocationName -Name $PublicIPAddressName -ResourceGroupName $ResourceGroupName
```

The New-AzPublicIpAddress cmdlet creates a public IP address. (autogenerated)

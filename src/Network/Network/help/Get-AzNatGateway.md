...
```
PS C:> Get-AzNatGateway -Name nat_gateway -ResourceGroupName natgateway_test
```

Gets a Nat Gateway resource in a resource group by name OR NatGateway Id OR all Nat Gateway resources in a resource group. (autogenerated)

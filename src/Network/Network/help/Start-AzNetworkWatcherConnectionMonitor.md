...
```
PS C:> Start-AzNetworkWatcherConnectionMonitor -Location westus -Name cm
```

The Start-AzNetworkWatcherConnectionMonitor cmdlet starts the specified connection monitor. (autogenerated)

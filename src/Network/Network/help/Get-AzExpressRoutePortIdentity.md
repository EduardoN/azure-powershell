...
```
PS C:> Get-AzExpressRoutePortIdentity -ExpressRoutePort $exrPort
```

The Get-AzExpressRoutePortIdentity cmdlet gets identity assigned to a local Azure ExpressRoutePort object. (autogenerated)

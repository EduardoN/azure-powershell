...
```
PS C:> New-AzDdosProtectionPlan -Location West US -Name DdosProtectionPlanName -ResourceGroupName ResourceGroupName -Tag $tag
```

The New-AzDdosProtectionPlan cmdlet creates a DDoS protection plan. (autogenerated)

...
The New-AzPrivateLinkServiceIpConfig cmdlet creates a private link service ip configuration. This configuration is used for source NAT-ing the incoming traffic from private endpoint.  (autogenerated)

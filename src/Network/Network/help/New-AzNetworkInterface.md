...
```
PS C:> New-AzNetworkInterface -Location $LocationName -Name $NICName -NetworkSecurityGroupId {NetworkSecurityGroupId} -PublicIpAddressId $PIP.Id -ResourceGroupName $ResourceGroupName -SubnetId $Vnet.Subnets[0].Id
```

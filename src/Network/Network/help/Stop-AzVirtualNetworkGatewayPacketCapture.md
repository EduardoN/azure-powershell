...
PS C:> Stop-AzVirtualNetworkGatewayPacketCapture -InputObject $virtualWan -SasUrl $sasurl
```

Stops Packet Capture Operation on a Virtual Network Gateway and will upload the result on given SasUrl of storage container. (autogenerated)

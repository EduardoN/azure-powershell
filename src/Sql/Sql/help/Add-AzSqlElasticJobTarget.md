...
PS C:> Add-AzSqlElasticJobTarget -ElasticPoolName ElasticPool01 -RefreshCredentialName cred1 -ServerName s1
```

The Add-AzSqlElasticJobTarget cmdlet adds a target resource to a target group (autogenerated)

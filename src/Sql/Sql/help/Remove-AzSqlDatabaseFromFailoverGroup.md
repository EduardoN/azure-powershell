...
```
PS C:> Remove-AzSqlDatabaseFromFailoverGroup -FailoverGroupName fg -ResourceGroupName MyResourceGroup -ServerName s1
```

This command removes one database from a Failover Group by piping it in. (autogenerated)

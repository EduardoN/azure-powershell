...
PS C:> Remove-AzSqlInstancePool -Name instancePool0 -ResourceGroupName resourcegroup01 -WhatIf 
```

The Remove-AzSqlInstancePool cmdlet removes an Azure SQL Instance pool. (autogenerated)

...
PS C:> Set-AzSqlDatabaseSensitivityClassification -ColumnName column -InformationType informationType -SchemaName schema -SensitivityLabel label -TableName table
```

The Set-AzSqlDatabaseSensitivityClassification cmdlet sets the information types and sensitivity labels of columns in the database. (autogenerated)

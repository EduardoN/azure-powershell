...
## DESCRIPTION
The **Set-AzServiceBusGeoDRConfigurationFailOver** cmdlet invokes GEO DR failover and reconfigure the alias to point to the secondary namespace
...
PS C:> Set-AzServiceBusGeoDRConfigurationFailOver -Name SampleDRConfigName -Namespace SampleNamespace_Secondary -ResourceGroupName SampleResourceGroup -WhatIf 
```

The Set-AzServiceBusGeoDRConfigurationFailOver cmdlet invokes GEO DR failover and reconfigure the alias to point to the secondary namespace (autogenerated)

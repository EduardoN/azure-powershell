...
The Remove-AzServiceBusAuthorizationRule cmdlet removes the authorization rule of a Service Bus namespace or queue or topic for the specified resource group. (autogenerated)

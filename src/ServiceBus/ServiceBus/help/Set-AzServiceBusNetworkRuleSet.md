...
PS C:> Set-AzServiceBusNetworkRuleSet -DefaultAction Allow -IPRule $IpRules -Name ServiceBus-Namespace1-1375 -ResourceGroupName v-ajnavtest -VirtualNetworkRule $VirtualNetworkRules
```

Update the NetwrokruleSet of the given Namespace in the current Azure subscription. (autogenerated)

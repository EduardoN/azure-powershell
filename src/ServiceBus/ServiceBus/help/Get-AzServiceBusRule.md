...
```
PS C:> Get-AzServiceBusRule -Namespace SBExample1 -ResourceGroupName Default-ServiceBus-WestUS -Subscription SBSubscription -Topic SBTopic
```

Returns list of rule descriptions for a specified subscription.  By default 100 rule will be returned, if more than 100 rule to be returned, please use -MaxCount Parameter. (autogenerated)

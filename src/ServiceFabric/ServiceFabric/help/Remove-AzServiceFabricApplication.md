...
```
PS C:> Remove-AzServiceFabricApplication -ClusterName $clusterName -Force  -Name $appName -ResourceGroupName $resourceGroupName
```

This cmdlet removes an application form the cluster. This will remove all the services, if any, under the application resource. (autogenerated)

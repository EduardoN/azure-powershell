...
Use Add-AzServiceFabricNode to add nodes to the specific node type. You just need to specify the number of nodes you want to add to a node type. (autogenerated)

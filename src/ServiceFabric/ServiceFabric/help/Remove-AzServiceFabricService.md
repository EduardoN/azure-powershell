...
```
PS C:> Remove-AzServiceFabricService -ApplicationName $appName -ClusterName $clusterName -Force  -Name $serviceName -ResourceGroupName $resourceGroupName
```

This cmdlet removes a service form the cluster. (autogenerated)

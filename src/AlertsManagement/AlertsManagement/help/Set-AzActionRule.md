...
PS C:> Set-AzActionRule -ActionRuleType ActionGroup -DescriptionCondition {DescriptionCondition} -Name Test-AR -ReccurenceType Weekly -ResourceGroupName test-rg -Scope /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/alertslab,/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Test-VMs -Status Enabled
```

Set-AzActionRule creates or updates an action rule. (autogenerated)

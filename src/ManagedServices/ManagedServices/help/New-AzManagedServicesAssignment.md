...
```
PS C:> New-AzManagedServicesAssignment -RegistrationDefinition $def -Scope /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/mygroup1
```

Creates or updates a registration assignment. (autogenerated)

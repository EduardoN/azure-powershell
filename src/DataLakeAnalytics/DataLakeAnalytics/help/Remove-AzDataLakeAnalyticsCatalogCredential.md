...
```
PS C:> Remove-AzDataLakeAnalyticsCatalogCredential -Account ContosoAdla -DatabaseName DatabaseName -Name My firewall rule
```

This command removes the specified Data Lake Analytics catalog credential. (autogenerated)

...
```
PS C:> Remove-AzDataLakeAnalyticsAccount -Force 
```

The Remove-AzDataLakeAnalyticsAccount cmdlet permanently deletes an Azure Data Lake Analytics account. (autogenerated)

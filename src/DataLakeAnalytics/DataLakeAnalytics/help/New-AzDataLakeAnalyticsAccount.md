...
```
PS C:> New-AzDataLakeAnalyticsAccount -DefaultDataLakeStore ContosoAdlStore -Location East US 2 -Name ContosoAdlAccount -ResourceGroupName ContosoOrg -Tag {Tag}
```

The New-AzDataLakeAnalyticsAccount cmdlet creates an Azure Data Lake Analytics account. (autogenerated)

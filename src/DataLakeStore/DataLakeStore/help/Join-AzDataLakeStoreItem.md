...
```
PS C:> Join-AzDataLakeStoreItem -Account ContosoADL -Destination /MyFiles/CombinedFile.txt -Paths /MyFiles/File01.txt,/MyFiles/File02.txt
```

This command joins File01.txt and File02.txt to create the file CombinedFile.txt. (autogenerated)

...
```
PS C:> Set-AzDataLakeStoreItemAclEntry -Account ContosoADL -AceType User -Id {Id} -Path / -Permissions All
```

This command modifies the ACE for Patti Fuller to have all permissions. (autogenerated)

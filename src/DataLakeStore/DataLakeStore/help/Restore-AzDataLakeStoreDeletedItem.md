...
```
PS C:> Restore-AzDataLakeStoreDeletedItem -Account ml1ptrashtest -Destination adl://ml1ptrashtest.azuredatalake.com/test0/file_1230 -Force  -Path 00000000-0000-0000-0000-000000000000 -Type file
```
